Feature: Multiple Placeholder Files
  In order to avoid clutter
  As a feature writer
  I must be able to use multiple smaller placeholder files on Feature Backgrounds
  ...
  Background:
    ...
    And a file named "features/placeholders/default.yml" with:
      ...
      """
    And a file named "features/placeholders/ice_cream_vanilla.yml" with:
      """
      default:
        placeholders:
          flavor:
            $default:
              $vanilla: vanilla
      """
    And a file named "features/placeholders/ice_cream_chocolate.yml" with:
      """
      default:
        placeholders:
          flavor:
            $default:
              $chocolate: chocolate
      """
    And a file named "features/placeholders/ice_cream_pistachio.yml" with:
      """
      default:
        placeholders:
          flavor:
